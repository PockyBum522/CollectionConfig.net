...
public class JsonCacheLoaderTests
{
    ...
    public void SetUp()
    {
        ...
        _sut = new JsonCacheLoader(_dataStoreReaderMock);
        
        _dataStoreReaderMock.Read().Returns(RawData.JsonRaw);
    }
    ...
    [Test]
    public void JsonCacheLoader_WhenBuiltWithMockIDataStoreReader_ShouldNotBeNull()
    {
    ...
    [TestCase(2, "MilesRun")]
    [TestCase(3, "PetsName")]
    public void JsonCacheLoader_DataStoreElementsFetched_FirstRowKeysShouldBeCorrect(int index, string expected)
    {
    ...
    [TestCase(2, "3.15")]
    [TestCase(3, "Whiskey")]
    public void JsonCacheLoader_DataStoreElementsFetched_FirstRowValuesShouldBeCorrect(int index, string expected)
    {
        var result = _sut?.UpdateCachedDataFromFile();
    ...
    [TestCase(2, "MilesRun")]
    [TestCase(3, "PetsName")]
    public void JsonCacheLoader_DataStoreElementsFetched_LastRowKeysShouldBeCorrect(int index, string expected)
    {
        var result = _sut?.UpdateCachedDataFromFile();
    ...
    [TestCase(2, "2.23")]
    [TestCase(3, "Trixie")]
    public void JsonCacheLoader_DataStoreElementsFetched_LastRowValuesShouldBeCorrect(int index, string expected)
    {
        var result = _sut?.UpdateCachedDataFromFile();
